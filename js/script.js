...
const translations = {
  ru: {
    ...
    'memes.caption': 'Поменяй этот арт на ключевой визуал в любой момент.',
    'memes.chip': 'Призыв II · Мем-зов',
    'memes.title': 'Теперь ты бессмертный.',
    'memes.paragraph1': 'Именно так я хочу однажды сказать. Или хотя бы: «Средняя жизнь — 1000 лет, и мы выглядим вечно молодыми — как в 20–30». Сегодня это невозможно. А завтра ещё не наступило. Поэтому продлим жизнь иначе — доступным уже сейчас способом, чтобы увеличить шансы дожить до дня, когда эти слова станут реальностью.',
    'memes.paragraph2': 'Наш инструмент № 1 — смех. Исследования давно показывают его пользу; не веришь — спроси Google, ChatGPT или Grok (подтвердят… скорее всего). Так что начнём с того, что уже у нас в руках.',
    'memes.paragraph3': 'Я призываю тебя: создавай мемы — смешные, дерзкие, вдохновляющие. Ролики, картинки, гифки… всё, что заставит мир улыбнуться. Пусть мир смеётся с RAKODI (и над RAKODI).',
    'memes.paragraph4': 'Отмечай @rakodi во всех соцсетях и заслужи место в нашем Пантеоне героев. Потому что герои — это те, кто продлевают жизнь другим людям. Лучшие работы попадут на этот сайт — в раздел «Легендарные мемы RAKODI».',
    'memes.primaryCta': 'Залить свой мем',
    'memes.secondaryCta': 'Отметь @rakodi · Присоединяйся к сигналу',
    'memes.hashtag1': '#БессмертныйМем',
    'memes.hashtag2': '#ПантеонRakodi',
    'memes.hashtag3': '#СмехПродлевает',
  ...
  en: {
    ...
    'memes.caption': 'Swap this art for your meme key visual at any time.',
    'memes.chip': 'Call II · Meme Summons',
    'memes.title': 'You Are Immortal Now.',
    'memes.paragraph1': 'That’s what I want to say one day. Or at least: “From now on, the average lifespan is 1,000 years, and we’ll look forever young — like we’re 20–30.” Today, I can’t say that. Tomorrow hasn’t arrived yet. So let’s extend life another way — available right now — to increase our chances of living to the day when I can truly say those words.',
    'memes.paragraph2': 'Our Tool No. 1 is laughter. Research has long shown its power; don’t just take my word for it — ask Google, ChatGPT, or Grok (they’ll confirm… probably). So we start with what we already have.',
    'memes.paragraph3': 'I call on you: create memes — funny, daring, majestic. Videos, images, GIFs — anything that makes the world smile. Let the world laugh with RAKODI (and at RAKODI).',
    'memes.paragraph4': 'Tag @rakodi on any social platform and earn your place in our Pantheon of Heroes. Because heroes are the ones who extend other people’s lives. The best of your work will appear here on the site under “Legendary RAKODI Memes.”',
    'memes.primaryCta': 'Drop Your Meme',
    'memes.secondaryCta': 'Tag @rakodi · Join the Signal',
    'memes.hashtag1': '#ImmortalMeme',
    'memes.hashtag2': '#RakodiPantheon',
    'memes.hashtag3': '#LaughLonger',
